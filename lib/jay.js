      ...
      kaiseki.createObject(table, fields, function(err, response, body, success) {
        ...
        if(success) {
          ...
          if(files[firstKey]) {
            ...
            protectedCallback(res, callback, { objectId: body.objectId })
          }
        } else {
          //callback({error: err});
          protectedCallback(res, callback, {error: err})
  ...
  self.logIn = function(request, response, config, callback) {
    ...
    request.on('end', function() {
      ...
      try { ajax_object = JSON.parse(data) } catch(err) {
        ...
        protectedCallback(res, callback, { error: true, type: 'data', message: 'data could not be parsed'})
      };
        ...
        var optionsget = {
         ...
         var reqGet = https.request(optionsget, function(res) {
          if (res.statusCode != 200) {
            ...
            protectedCallback(res, callback, { error: true, type: 'data', message: 'res.statusCode != 200'})
          };
          ...
          res.on('data', function(d) {
            ...
            try {
              ...
              protectedCallback(res, callback, { error: true, type: 'data', message: 'oAuth fails'})
            };
          });
        });
